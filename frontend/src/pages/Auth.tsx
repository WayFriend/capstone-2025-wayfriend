...
const Auth: React.FC = () => {
  ...
  const WayFriendsIcon = () => (
    <svg style={{ height: '2.5rem', width: '2.5rem', color: '#137fec' }} fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              className="w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              id="email"
              name="email"
        ...
        <div className="mt-6 text-center">
          <a className="text-sm font-medium text-[var(--primary-color)] hover:text-blue-700" href="#">
            Forgot Password?
          </a>
        </div>
      </div>
